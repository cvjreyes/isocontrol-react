...
class PipingDataTable extends React.Component {
  //Tabla de lineas modeladas tipo isotracker
  state = {
    searchText: "",
    searchedColumn: "",
    data: [],
        ...
        if (json.rows) {
          for (let i = 0; i < json.rows.length; i++) {
            ...
            if (
              ...
              //Comprobamos si la iso correspondiente a la linea se ha subido a isotracker
              notInSDesignButton = (
                <img
                  src={warningIT}
                  alt="warning"
            ...
            let row = {
              ...
              actions: (
                <div>
                  {claimedBtn} {vButton} {iButton} {naButton}{" "}
                  {notInSDesignButton}
                </div>
              ),
            };
            ...
            if (
              ...
              this.state.tab !== "PipingSDesign"
            ) {
              //Indicamos el progreso de la linea
              if (row.type === "TL1") {
                row.progress =
  ...
  async componentDidUpdate(prevProps, prevState) {
    if (
      ...
      prevProps.updateData !== this.props.updateData
    ) {
      this.props.loading(true);
      let options = {
        method: "GET",

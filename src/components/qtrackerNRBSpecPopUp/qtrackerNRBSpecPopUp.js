          ...
          this.setState({
            attachComponent: (
              <tr className="specs__row">
                ...
                >
                  <p className="specs__description__text">
                    {" "}
                    <Link onClick={() => this.getAttach(json.filename)}>
                      {json.filename}
                    </Link>
                  </p>
                </td>
    ...
    return (
      <div style={{ marginRight: "5px", marginLeft: "5px", float: "left" }}>
        <button
          ...
          style={{ fontSize: "16px", padding: "2px 5px 2px 5px" }}
        ...
        <div>
          ...
          >
            <center className="popUp__title">
              <h3>
                <strong>{this.props.incidence_number}</strong>
              </h3>
            </center>

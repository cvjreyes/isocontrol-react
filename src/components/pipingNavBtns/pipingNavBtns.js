...
const PipingNavBtns = (props) => {
  ...
  if (props.currentTab === "EstimatedPipes") {
    ...
    isoControlEstimatedBtn = (
      <button
        type="button"
        className="trays__navBtns text-left"
        style={{
  ...
  if (process.env.REACT_APP_IFC === "0") {
    prodBtn = (
      <button
        ...
        className="trays__navBtns text-left"
        onClick={() =>
          history.push("/" + process.env.REACT_APP_PROJECT + "/pipingProgress")
        }
      >
        IFDProgress
      </button>
    ...
    prodBtn = (
      <button
        ...
        onClick={() =>
          history.push(
            "/" + process.env.REACT_APP_PROJECT + "/pipingProduction"
          )
        }
      >
        Production

  ...
  useEffect(async () => {
    if (process.env.REACT_APP_PROGRESS === "1") {
      ...
      await setTotalWeight(
        pipesWeight + equisWeight + instsWeight + civilsWeight + elecsWeight
      );
      await setTotalProgress(
        (
          (pipesWeight / totalWeight) * pipesProgress +
          (equisWeight / totalWeight) * equisProgress +
          (civilsWeight / totalWeight) * civilsProgress +
          (instsWeight / totalWeight) * instsProgress +
          (elecsWeight / totalWeight) * elecsProgress
        ).toFixed(2)
      );
    ...
    if (process.env.REACT_APP_PROGRESS === "1") {
      setProgressButtons(
        <div>
          <div className="panel__content__container">
            <div>
              <a
                href={"/" + process.env.REACT_APP_PROJECT + "/3dprogress"}
                style={{ textDecoration: "none" }}
              >
                <h4
                  className="panel__icon__container"
                  onMouseEnter={() => setProgIsShown(true)}
                  onMouseLeave={() => setProgIsShown(false)}
                >
                  <img
                    src={ChartColorIcon}
                    alt="chart"
          ...
          <div className="panel__content__container">
            <div>
              <a
                href={"/" + process.env.REACT_APP_PROJECT + "/piping"}
                style={{ textDecoration: "none" }}
              >
                <h4
                  className="panel__icon__container"
                  onMouseEnter={() => setPipeIsShown(true)}
                  onMouseLeave={() => setPipeIsShown(false)}
                >
                  <img src={PipeIcon} alt="pipe" className="panel__icon" />
                  &nbsp;&nbsp;&nbsp;Piping (Weight: {pipesWeight} |{" "}
                  {(
                    (pipesWeight /
                      (pipesWeight +
                        equisWeight +
              ...
              <div className="progress" style={{ height: "25px" }}>
                <div
                  ...
                  style={{
                    color: "black",
                    fontSize: "15px",
                    width: pipesProgressWidth,
                    backgroundColor: "#94dcaa",
                    textAlign: "center",
                  }}
                >
                  <span className="sr-only"></span>
                  <strong>{pipesProgress}%</strong>
                </div>
              </div>
            </div>
          </div>
          <div className="panel__content__container">
            <div>
              <a
                href={"/" + process.env.REACT_APP_PROJECT + "/equipments"}
                style={{ textDecoration: "none" }}
              >
                <h4
                  className="panel__icon__container"
                  onMouseEnter={() => setEquipIsShown(true)}
                  onMouseLeave={() => setEquipIsShown(false)}
                >
                  <img src={EquiIcon} alt="equi" className="panel__icon" />
                  &nbsp;&nbsp;&nbsp;Equipment (Weight: {equisWeight} |{" "}
                  {(
                    (equisWeight /
                      (pipesWeight +
                        equisWeight +
              ...
              <div className="progress" style={{ height: "25px" }}>
                <div
                  ...
                  style={{
                    color: "black",
                    fontSize: "15px",
                    width: equisProgressWidth,
                    backgroundColor: "#94dcaa",
                    textAlign: "center",
                  }}
                >
                  <span className="sr-only"></span>
                  <strong>{equisProgress}%</strong>
                </div>
              </div>
            </div>
          </div>
          <div className="panel__content__container">
            <div>
              <a
                href={"/" + process.env.REACT_APP_PROJECT + "/civil"}
                style={{ textDecoration: "none" }}
              >
                <h4
                  className="panel__icon__container"
                  onMouseEnter={() => setCivIsShown(true)}
                  onMouseLeave={() => setCivIsShown(false)}
                >
                  <img src={StruIcon} alt="stru" className="panel__icon" />
                  &nbsp;&nbsp;&nbsp;Civil (Weight: {civilsWeight} |{" "}
                  {(
                    (civilsWeight /
                      (pipesWeight +
                        equisWeight +
              ...
              <div className="progress" style={{ height: "25px" }}>
                <div
                  ...
                  style={{
                    color: "black",
                    fontSize: "15px",
                    width: civilsProgressWidth,
                    backgroundColor: "#94dcaa",
                    textAlign: "center",
                  }}
                >
                  <span className="sr-only"></span>
                  <strong>{civilsProgress}%</strong>
                </div>
              </div>
            </div>
          </div>
          <div className="panel__content__container">
            <div>
              <a
                href={"/" + process.env.REACT_APP_PROJECT + "/instrumentation"}
                style={{ textDecoration: "none" }}
                className="panel__content__link"
              >
                <h4
                  className="panel__icon__container"
                  onMouseEnter={() => setInstIsShown(true)}
                  onMouseLeave={() => setInstIsShown(false)}
                >
                  <img src={InstIcon} alt="inst" className="panel__icon" />
                  &nbsp;&nbsp;&nbsp;Instrumentation (Weight: {
                    instsWeight
                  } |{" "}
                  {(
              ...
              <div className="progress" style={{ height: "25px" }}>
                <div
                  ...
                  style={{
                    color: "black",
                    fontSize: "15px",
                    width: instsProgressWidth,
                    backgroundColor: "#94dcaa",
                    textAlign: "center",
                  }}
                >
                  <span className="sr-only"></span>
                  <strong>{instsProgress}%</strong>
                </div>
              </div>
            </div>
          </div>
          <div className="panel__content__container">
            <div>
              <a
                href={"/" + process.env.REACT_APP_PROJECT + "/electrical"}
                style={{ textDecoration: "none" }}
                className="panel__content__link"
              >
                <h4
                  className="panel__icon__container"
                  onMouseEnter={() => setElecIsShown(true)}
                  onMouseLeave={() => setElecIsShown(false)}
                >
                  <img src={ElecIcon} alt="inst" className="panel__icon" />
                  &nbsp;&nbsp;&nbsp;Electrical (Weight: {elecsWeight} |{" "}
                  {(
                    (elecsWeight /
                      (pipesWeight +
                        equisWeight +
              ...
              <div className="progress" style={{ height: "25px" }}>
                <div
                  ...
                  style={{
                    color: "black",
                    fontSize: "15px",
                    width: elecsProgressWidth,
                    backgroundColor: "#94dcaa",
                    textAlign: "center",
                  }}
                >
                  <span className="sr-only"></span>
                  <strong>{elecsProgress}%</strong>
                </div>
              </div>
            </div>
          </div>
      ...
      setProgressButtons(
        <div className="panel__content__container">
          <div>
            <a
              href={"/" + process.env.REACT_APP_PROJECT + "/isotracker"}
              style={{ textDecoration: "none" }}
            >
              <h4
                className="panel__icon__container"
                onMouseEnter={() => setIsoIsShown(true)}
                onMouseLeave={() => setIsoIsShown(false)}
              >
                <img src={FileIcon} alt="file" className="panel__icon" />
                &nbsp;&nbsp;&nbsp;IsoTracker
              </h4>
              <div
  ...
  return (
    <div className="panel__container">
      <div className="panel__heading__container">
        <h4>
          <p className="panel__heading__text">
            <strong style={{ fontWeight: "700" }}>3D</strong>Tracker
          </p>
        </h4>
      </div>
        ...
        <div className="menu">
          <div className="panel__content__container__title">
            ...
            >
              ...
              <h4 className="iso__title__menu">
                ISO<p style={{ fontWeight: "100" }}>Tracker</p>
              </h4>
            </a>
          </div>

          <h4 className="disciplines__text">
            You can also click any of the items below to check disciplines.
          </h4>

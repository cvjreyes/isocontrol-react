...
const PipingProgress = () => {
  ...
  async function submitEstimatedForecastIFD() {
    //Submit del forecast de isocontrol
    const body = {
                      ...
                      await overallTable.push(
                        ...
                        >
                          <div style={{ display: "flex" }}>
                            <p className="materials__title">Progress</p>
                            <button
                              className="save__button"
                              onClick={() => submitEstimatedForecastIFD()}
                            >
                              <img
                                src={SaveIcon}
                                alt="save"
  ...
  return (
    <body style={{ overflow: "hidden", height: "100vh" }}>
      ...
      <div id="pdf">
        ...
        <div className="materials__tables__container">{overallTable}</div>
      </div>
    </body>
  );
};

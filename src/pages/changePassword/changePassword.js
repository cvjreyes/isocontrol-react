    ...
    <body>
      <div
        className={`alert alert-success ${
          blankError ? "alert-shown" : "alert-hidden"
        }`}
        onTransitionEnd={() => setBlankError(false)}
      >
        <AlertF
          type="error"
          subtext="At least one field is blank!"
          change={true}
        />
      </div>
      <div
        className={`alert alert-success ${
          wrongPassError ? "alert-shown" : "alert-hidden"
        }`}
        onTransitionEnd={() => setWrongPassError(false)}
      >
        <AlertF
          type="error"
          subtext="The current password is not correct!"
          change={true}
        />
      </div>
      <div
        className={`alert alert-success ${
          notCoincideError ? "alert-shown" : "alert-hidden"
        }`}
        onTransitionEnd={() => setNotCoincideError(false)}
      >
        <AlertF
          type="error"
          subtext="The passwords don't match!"
          change={true}
        />
      </div>
      <div
        className={`alert alert-success ${
          successful ? "alert-shown" : "alert-hidden"
        }`}
      ...
      <div className="background">
        ...
        <div className="login__form">
          ...
          />
          <p className="welcome__text" style={{ width: "250px" }}>
            Change password
          </p>
          <p className="enter__text">
            Please, enter your current password, current password confirmation
            and new password.
          </p>
          <p className="email__label" style={{ width: "120px" }}>
            Current password
          </p>
          <div>
            <input
              className="current__password__input"
            ...
            <img
              ...
              src={Eye}
              alt="eye"
              className="current__password__eye__image"
            ></img>
          </div>
          <p className="password__label" style={{ width: "220px" }}>
            New password
          </p>
          <div>
            <input
              className="conf__password__input"
            ...
            <img
              ...
              src={Eye}
              alt="eye"
              className="conf__password__eye__image"
            ></img>
          </div>
          <p className="new__password__label" style={{ width: "160px" }}>
            Confirm new password
          </p>
          <div>
            <input
              className="new__password__input"
            ...
            <img
              ...
              src={Eye}
              alt="eye"
              className="new__password__eye__image"
            ></img>
          </div>
          <div className="login__buttons" style={{ top: "420px" }}>
            <button className="login__button" onClick={handelChangePassword}>
              Save
            </button>

...
const CSPTracker = () => {
    ...
    await fetch(
      ...
      .then(async (json) => {
        let counter = [
          ...
          { name: "Hold", value: json.hold },
          { name: "OK-REV0", value: json.ok_rev0 },
          { name: "OK-REVN", value: json.ok_revn },
          { name: "Excluded", value: json.excluded },
          { name: "Deleted", value: json.deleted },
        ];
  ...
  let editBtn,
    ...
    requestBtn,
    notificationsBtn,
    designNotificationsBtn = null;
  let table = (
    <CSPTrackerdDataTable
  ...
  if (currentRole === "Materials") {
    editBtn = (
      <label className="switchBtn" style={{ width: "145px" }}>
        <p
    ...
    if (currentTab === "Edit") {
      ...
      notificationsBtn = (
        ...
        >
          ...
          ></img>
          <p className="navBar__button__text">Requests</p>
        </button>
      );
    } else {
      notificationsBtn = (
  ...
  if (currentRole === "3D Admin") {
    editBtn = (
      <label className="switchBtn" style={{ width: "155px" }}>
        <p
          className="navBar__button__text"
        ...
        <div className="slide round" style={{ marginLeft: "90px" }}></div>
      </label>
    );
  }
  ...
  if (currentTab === "View") {
    ...
    if (!busy) {
      table = (
        <HotTable
          ...
          columns={[
            ...
            { data: "line_id", type: "text" },
            { data: "pid", type: "dropdown", strict: "true", source: pidData },
            { data: "type", type: "text" },
            {
            ...
            { data: "requisition", type: "text" },
            { data: "description", type: "text" },
            { data: "description_iso", type: "text" },
            { data: "ident", type: "text" },
            { data: "face_to_face", type: "text" },
            {
              data: "bolt_type",
              type: "dropdown",
              strict: "true",
            ...
            { data: "equipnozz", type: "text" },
            { data: "utility_station", type: "text" },
      ...
      table = (
        <div className="connected__panel">
          <p className="connected__text">
            The user {editingUser} is already editing!
          </p>
        </div>
      );
    }
  ...
  return (
    <body>
      ...
      <div
        className={`alert alert-success ${
          uploadDrawingSuccess ? "alert-shown" : "alert-hidden"
        }`}
      ...
      <div
        className={`alert alert-success ${
          updateDrawingSuccess ? "alert-shown" : "alert-hidden"
        }`}
      ...
      <div
        className={`alert alert-success ${
          noTagError ? "alert-shown" : "alert-error-hidden"
        }`}
      ...
      <div
        className={`alert alert-success ${
          invalidFieldError ? "alert-shown" : "alert-error-hidden"
        }`}
      ...
      <div
        className={`alert alert-success ${
          requestSuccess ? "alert-shown" : "alert-error-hidden"
        }`}
      ...
      <div
        className={`alert alert-success ${
          warningBlankRequest ? "alert-shown" : "alert-error-hidden"
        }`}
      ...
      <div
        className={`alert alert-success ${
          existsRequest ? "alert-shown" : "alert-error-hidden"
        }`}
      ...
      <div
        className={`alert alert-success ${
          errorPid ? "alert-shown" : "alert-error-hidden"
        }`}
      ...
      <center className="actionBtns__container">
        <div style={{ display: "flex", marginTop: "10px" }}>{exportBtn}</div>
      </center>
      <br></br>
    </body>
  );
